...
const workout: any = {
  ...
  sets:[
    {id:'work',exercise:'barbell-bench-press',weight:80,reps:8,completed:true,setType:'N'},
    {id:'warm',exercise:'barbell-bench-press',weight:40,reps:10,completed:true,setType:'W'},
  ],
};
...
const history = extractExerciseHistory([workout], 'barbell-bench-press');
