        ...
        <div className="flex flex-col gap-2 relative">
          <Button
            ...
            onClick={() => {
              ...
              navigate('/brain', {
                state: {
                  autoPrompt: `I just finished "${workout.title || 'my workout'}". Volume ${stats.totalVolume}kg across ${stats.totalSets} sets. ${stats.forgeLearned.map((l) => l.text).join('; ')}. Suggest one concrete adjustment for next time as a proposal.`,
                },
              });
            }}
          >
            <Brain size={16} /> Ask Brain what to do next
          </Button>
          <Button
            size="lg"
            variant="outline"
